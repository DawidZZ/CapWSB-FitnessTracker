    ...
    private List<Training> generateTrainingData(List<User> users) {
        ...
        try {
            ...
            Training training1 = new Training(users.get(0),
                    sdf.parse("2026-01-11 08:00:00"),
                    sdf.parse("2026-01-11 09:30:00"),
                    ActivityType.RUNNING,
                    10.5,
                    8.2);

            Training training2 = new Training(users.get(1),
                    sdf.parse("2026-01-10 15:30:00"),
                    sdf.parse("2026-01-10 17:00:00"),
                    ActivityType.CYCLING,
                    25.0,
                    18.5);

            Training training3 = new Training(users.get(2),
                    sdf.parse("2026-01-09 07:45:00"),
                    sdf.parse("2026-01-09 09:00:00"),
                    ActivityType.WALKING,
                    5.2,
                    5.8);

            Training training4 = new Training(users.get(3),
                    sdf.parse("2026-01-08 18:00:00"),
                    sdf.parse("2026-01-08 19:30:00"),
                    ActivityType.RUNNING,
                    12.3,
                    9.0);

            Training training5 = new Training(users.get(4),
                    sdf.parse("2026-01-07 12:30:00"),
                    sdf.parse("2026-01-07 13:45:00"),
                    ActivityType.CYCLING,
                    18.7,
                    15.3);

            Training training6 = new Training(users.get(5),
                    sdf.parse("2026-01-06 09:00:00"),
                    sdf.parse("2026-01-06 10:15:00"),
                    ActivityType.WALKING,
                    3.5,
                    4.0);

            Training training7 = new Training(users.get(6),
                    sdf.parse("2026-01-05 16:45:00"),
                    sdf.parse("2026-01-05 18:30:00"),
                    ActivityType.RUNNING,
                    15.0,
                    10.8);

            Training training8 = new Training(users.get(7),
                    sdf.parse("2026-01-05 11:30:00"),
                    sdf.parse("2026-01-05 12:45:00"),
                    ActivityType.CYCLING,
                    22.5,
                    17.2);

            Training training9 = new Training(users.get(8),
                    sdf.parse("2026-01-06 07:15:00"),
                    sdf.parse("2026-01-06 08:30:00"),
                    ActivityType.WALKING,
                    4.2,
                    4.5);

            Training training10 = new Training(users.get(9),
                    sdf.parse("2026-01-07 14:00:00"),
                    sdf.parse("2026-01-07 15:15:00"),
                    ActivityType.RUNNING,
                    11.8,
                    8.5);
